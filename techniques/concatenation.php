...
Browserscope" target="_blank">Browserscope</a></li>
	</ul>
	...
	<ul>
		...
		<li>Use LESS or SASS to turn your imports into include statements that will tie everything together</li>
		<li>A pre-processor such as CodeKit to facilitate this binding</li>
	</ul>
...
@media screen and (min-width: 1024px){
	...
	<p><strong>Example:</strong> <a href="http://s.c.lnkd.licdn.com/scds/common/u/img/sprite/sprite_global_v8.png" title="LinkedIn Sprite" target="_blank">LinkedIn</a></p>
	...
	<p><a href="http://stackoverflow.com/questions/138884/when-should-i-use-inline-vs-external-javascript" target="_blank">An old rule broken!</a></p>
